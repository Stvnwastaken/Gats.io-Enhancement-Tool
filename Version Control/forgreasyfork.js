// ==UserScript==
// @name         G.E.T Gats Enhancement Tool Beta Version 1.7.8 greasyfork
...
// ==/UserScript==
 ...
 /* Version Updates:
    ...
    V1.7.8 Added gui and optimized code*/
...
document.write(`
<html>
<h1>This gats enhancement tool script is not supported, for the offical script go here:</h1>
<div>
<a target="_blank" href="https://github.com/LightLordYT/Gats.io-Enhancement-Tool/blob/main/get.js">https://github.com/LightLordYT/Gats.io-Enhancement-Tool/blob/main/get.js</a>
</div>
  <body>INSTALLATION: Go to the link above and copy all the code. Then click the tampermonkey extension and create a new script. delete all the code in the new script and paste the new code in (that was from the github link)  </body>
</html>
`);
